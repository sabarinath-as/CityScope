...
class IssueAdmin(admin.ModelAdmin):
    ...
    mark_in_progress.short_description = 'Mark selected issues as In Progress'
...
class CommentAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'issue', 'text', 'created_at']
    search_fields = ['user__username', 'issue__title', 'text']


@admin.register(Notification)
class NotificationAdmin(admin.ModelAdmin):
    list_display = ['id', 'user', 'issue', 'notification_type', 'is_read', 'created_at']
